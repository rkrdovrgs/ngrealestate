...
System.register(["typescript"], function (exports_1, context_1) {
    ...
    function loadTsconfigOptions(options, parentAddress, fetchJson) {
        return __awaiter(this, void 0, void 0, function () {
            var tsconfigName, tsconfigText, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        if (result.error) {
                            ...
                            return [2, result.config.compilerOptions];
                        }
                        return [3, 3];
    ...
    function validateOptions(options) {
        if ((options.module != typescript_1["default"].ModuleKind.System) && (options.module != typescript_1["default"].ModuleKind.ES2015)) {
